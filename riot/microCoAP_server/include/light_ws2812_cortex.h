...
#define LIGHT_WS2812_SAMR21

#include "microCoAPServer.h"
...
#endif
#ifdef LIGHT_WS2812_SAMR21
  #include "samr21g18a.h"
  #define LIGHT_WS2812_SAMR21
#endif


//#define LIGHT_WS2812_STM32 __SAMR21G18A__
//#include "samr21g18a.h"
...
#ifdef LIGHT_WS2812_SAMR21
  // This example is for SAMR21 family
  //#define ws2812_port_set ((uint32_t*)&REG_PORT_DIRSET0)  // Address of the data port register to set the pin
  //#define ws2812_port_clr ((uint32_t*)&REG_PORT_DIRCLR0) // Address of the data port register to clear the pin

  #define ws2812_port_set ((uint32_t*)&REG_PORT_OUTSET0)
  #define ws2812_port_clr ((uint32_t*)&REG_PORT_OUTCLR0)

//REG_PORT_DIRSET0 |= (1 << 19);    


  #define ws2812_mask_set PIN_LED_STRIP  // Bitmask to set the data out pin
  #define ws2812_mask_clr PIN_LED_STRIP   //PIN_PA14   // Bitmask to clear the data out pin
#endif
